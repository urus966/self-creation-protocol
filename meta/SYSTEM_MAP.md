...
docs/protocols/Protocol_Hierarchy.md | Иерархия протоколов и уровни авторитета | A
docs/protocols/Conflict_Rules.md | Правила разрешения конфликтов между протоколами | A
