...
Presence Space is the default system state.
All other states (action, development, execution) are optional overlays, not upgrades.

### 2. Non-Transitional

Presence Space is not:

- a step before action
- a recovery phase
- a precondition for productivity

A system may remain in Presence Space indefinitely without error.

### 3. Consent-Gated Exit
